...
import copy
from detany3d_frontend.datasets.utils import (
    box3d_iou,
    angle2class,
    class2angle,
    points_img2cam,
...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        #  2d bbox - always apply sigmoid for normalized bbox regression
    ...
    def predict_masks_multi_level(
        ...
        if self.training:
            ...
            # box_iou_loss 仅在训练模式下有值，推理模式下返回 0
            box_iou_loss = torch.tensor(0.0, device=pred_center_2d.device)
